	...
	<head>
		...
		<style type="text/css">
			...
			@media screen and (max-width: 480px) {
				body[yahoo] .main-content {
					width: 100% !important;
				}
				body[yahoo] .mobile-hide {
					width: 10px !important;
				}
				body[yahoo] .product-table td {
					font-size: 13px !important;
				}
				body[yahoo] .main-heading {
			...
			@media screen and (max-width: 479px) {
				...
				body[yahoo] .product-table > tbody > tr > td {
					display: block;
					width: 100% !important;
				}
				body[yahoo] .feature-table > tbody > tr > td {
					display: block;
					width: 100% !important;
				}
				body[yahoo]  .hide {
				...
				body[yahoo]  .logo-table, body[yahoo] .social-media {
					float: none;
				}
				body[yahoo] .view-online td {
					width: 100%;
					display: block;
					padding: 2px 0px;
				}
				body[yahoo] .social-media {
					display: none;
				}
				body[yahoo] .banner-space {
					height: 125px !important;
				}
				body[yahoo] .apply-dis {
					font-size: 60px !important;
				}
				body[yahoo] .article-text {
					font-size: 19px !important;
				}
				body[yahoo] .top-space {
					height: 30px !important;
				}
				body[yahoo] .media-table {
					float: none;
				}
				body[yahoo] .contact-us {
					float: none;
					margin-bottom: 10px;
				}
				body[yahoo] .online-btn {
					width: 250px !important;
				}
				body[yahoo] .online-btn a {
	...
	<body style="width:680px !important; margin: 0 auto; color:#888888; font-family: 'Open Sans', Arial , sans-serif; font-weight:normal; font-size:11px; line-height:1; background:#e4e4e4;">
		...
		<!-- <table cellpadding="0" cellspacing="0" border="0" width="680" align="center" class="wrapper">
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						<td height="15"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
					</tr>
					<tr>
						<td valign="top" align="center" class="primary-header">
						<table cellpadding="0" cellspacing="0" border="0" align="center" class="view-online">
							<tr>
								<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:11px; color:#7e7380;">Email not displaying correctly? &nbsp;</td>
								<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:11px; color:#7e7380;"><a href="#" style="color:#7e7380; font-weight:400; text-decoration:underline;">View this email in your browser</a></td>
							</tr>
						</table></td>
					</tr>
					<tr>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" border="0"  align="left" width="171" style="text-align:center;" class="logo-table">
							<tr>
								<td style="text-align:center;"><a href="index.html" style="text-decoration:none;"><img src="https://cesarchabuluac.com/template/logo.png" alt="" width="130" height="37" border="0" style="display:block;" /></a></td>
							</tr>
							<tr>
								<td height="12"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
							</tr>
							<tr>
								<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:14px; line-height:1; font-style:italic; color:#aaaaaa; font-weight:normal; text-align:center; font-weight:400;  letter-spacing:1px;"></td>
							</tr>
						</table>
						<table cellpadding="0" cellspacing="0" border="0" width="191" align="right" class="social-media">
							<tr>
								<td height="13"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td height="13"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td height="13"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td height="13"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td height="13"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
							...
							<tr>
								<td align="center" width="40"><a href="#" style="display: block;"><img  src="https://cesarchabuluac.com/template/facebook.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
								<td align="center" width="10"><img  src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td align="center" width="40"><a href="#" style="display: block; "><img  src="https://cesarchabuluac.com/template/twitter.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
								<td align="center" width="10"><img  src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td align="center" width="40"><a href="#" style="display: block; "><img  src="https://cesarchabuluac.com/template/youtube.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
								<td align="center" width="10"><img  src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td align="center" width="40"><a href="#" style="display: block; "><img  src="https://cesarchabuluac.com/template/instagram.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
							</tr>
						</table></td>
					</tr>
					<tr>
						<td height="30" class="hide"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1"/></td>
					</tr>
				</table></td>
				<td width="40" class="gutter-width"><img src="https://cesarchabuluac.com/template/blank.gif"  alt="" width="1" height="1"/></td>
			</tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="680" align="center" class="wrapper" style="background:#ffffff;">
			<tr>
				<td width="40" class="gutter-width"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
				<td valign="top" align="center">
				<table cellpadding="0" cellspacing="0" border="0" width="530" align="center" class="main-content">
					<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="680" align="center" class="wrapper" style=" background-image:url(https://cesarchabuluac.com/template/map-bg.png); background-position:left top; background-size:100% auto;  background-color:#ffffff;">
			<tr>

				<td valign="top"><a href="#" style="text-decoration:none;"><img src="https://cesarchabuluac.com/template/map-image.png" alt="" width="680" height="400" border="0" style="display:block; width:100%;" /></a></td>

			</tr>
		</table>
		<!-- Section Twelve Ends Here -->
		<!-- Section Eleven Starts Hare -->
		<table cellpadding="0" cellspacing="0" border="0" width="680" class="wrapper" align="center" style="background:#443347; border-radius:0px 0px 4px 4px; ">
			<tr>
				<td width="40" class="gutter-width"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
				<td align="center">
				<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
					...
					<tr>
						<td valign="top" align="center">
						<table cellpadding="0" cellspacing="0" border="0"  align="left" class="contact-us">
							<tr>
								<td><img src="https://cesarchabuluac.com/template/phone-icn.png" alt="" width="40" height="40" border="0" style="display:block;" /></td>
								<td width="15"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td valign="middle"><a href="tel:3236223366" style="font-family: 'Open Sans', Arial , sans-serif; font-size:23px; font-weight:600; color:#ffffff;  text-decoration:none;">(323) 622-3366</a></td>
							</tr>
						</table>
						<table cellpadding="0" cellspacing="0" border="0" width="190" align="right" class="media-table">
							<tr>
								<td align="center" width="40"><a href="#" style="display: block;"><img  src="https://cesarchabuluac.com/template/facebook-1.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
								<td align="center" width="10"><img  src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td align="center" width="40"><a href="#" style="display: block; "><img  src="https://cesarchabuluac.com/template/twitter-1.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
								<td align="center" width="10"><img  src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td align="center" width="40"><a href="#" style="display: block; "><img  src="https://cesarchabuluac.com/template/youtube-1.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
								<td align="center" width="10"><img  src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
								<td align="center" width="40"><a href="#" style="display: block; "><img  src="https://cesarchabuluac.com/template/instagram-1.png" alt="" width="40" height="40" border="0" style="display: block;" /></a></td>
							</tr>
						</table></td>
					</tr>
					<tr>
		...
		<!-- Section Eleven Ends Hare -->
		<!-- Section Twelve Starts Hare -->
		<table cellpadding="0" cellspacing="0" border="0" width="680" class="wrapper" align="center">
			<tr>
				<td width="40" class="gutter-width"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
				<td valign="top">
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					...
					<tr>
						<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:13px; color:#7e7380; text-align:center; line-height:1;">&copy; 2015 Viway Limited. All Rights Reserved.</td>
					</tr>
					<tr>
						<td height="10"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
					</tr>
					<tr>
						<td valign="top" align="center">
						<table cellpadding="0" cellspacing="0" border="0" align="center" class="address">
							<tr>
								<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:13px; color:#7e7380; font-weight:400;  text-align:center; line-height:1;">Suite 77, 23-32 Sunny Rd, Saint Alberto, CA 22019</td>
							</tr>
						</table></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:11px; color:#7e7380; font-weight:400; text-align:center; line-height:1.2;">You signed up for this newsletter at the Company website.</td>
					</tr>
					<tr>
						<td height="5"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
					</tr>
					<tr>
						<td valign="top" align="center">
						<table cellspacing="0" cellpadding="0" border="0" align="center" class="subscribe-table">
							<tr>
								<td style="font-family: 'Open Sans', Arial , sans-serif; font-size:11px; text-align:center; font-weight:400; color:#7e7380;">Rather not receive our newsletter any more? No hard feelings:&nbsp;</td><td style="font-family: 'Open Sans', Arial , sans-serif; font-size:11px;"><a style="color:#7e7380; text-decoration:underline;" href="#">Unsubscribe</a></td>
							</tr>
						</table></td>
					</tr>
					<tr>
						<td height="32"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
					</tr>
				</table></td>
				<td width="40" class="gutter-width"><img src="https://cesarchabuluac.com/template/blank.gif" alt="" width="1" height="1" /></td>
			</tr>
		</table>
		<!-- Section Twelve Ends Hare -->
	</body>
</html>
