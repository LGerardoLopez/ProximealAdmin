...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
      ...
      <!-- Vehicle Id Field -->
    <div class="form-group row ">
        {!! Form::label('vehicle_id', trans("lang.vehicle"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('vehicle_id', $vehicle, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.user_vehicle_id_help") }}</div>
        </div>
    </div>
